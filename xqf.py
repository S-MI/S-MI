...
class MatchDemo:
    ...
    def default_platform(self):
        ...
        self.controller.up.CDS_SetAngle(6, 730, self.servo_speed)
    ...
    def pack_up_ahead(self):
        self.controller.up.CDS_SetAngle(5, 340, self.servo_speed)
        self.controller.up.CDS_SetAngle(7, 670, self.servo_speed)
    ...
    def pack_up_behind(self):
        self.controller.up.CDS_SetAngle(6, 350, self.servo_speed)
    ...
    def go_up_ahead_platform(self):
        ...
        self.controller.up.CDS_SetAngle(8, 720, self.servo_speed)
        time.sleep(1)
        # 默认上台
    ...
    def go_up_behind_platform(self):
        ...
        self.controller.up.CDS_SetAngle(8, 670, self.servo_speed)
        time.sleep(0.5)
        # 收起前爪
        self.controller.move_cmd(-1023,-1023)
        time.sleep(0.5)
        ...
        self.controller.up.CDS_SetAngle(7, 750, self.servo_speed)
        time.sleep(1)
        # 默认上台
        self.controller.up.CDS_SetAngle(5,700,self.servo_speed)
        self.controller.up.CDS_SetAngle(7,310,self.servo_speed)
    ...
    def fence_detect(self):
        ...
        # ----------------------对擂台，一个测距检测到--------------------
        if ad3 < 1000 and ad2 > 1000 and ad4 > 1000 and ad5 > self.FD and ad6 < self.RD and ad7 < self.BD and ad8 < self.LD:        #可
            # 在台下，后方对擂台
            return 1
        ...
        if ad1 < 1000 and ad2 > 1000 and ad4 > 1000 and ad5 < self.FD and ad6 < self.RD and ad7 > self.BD and ad8 < self.LD:        #可
            # 在台下，前方对擂台
            return 3
        if ad2 < 1000 and ad1 > 1000 and ad3 > 1000 and ad5 < self.FD and ad6 < self.RD and ad7 < self.BD and ad8 > self.LD:        #可
            # 在台下，右侧对擂台
            return 4
        # ------------------------对围栏，两个相邻测距检测到-------------
        if ad2 > 1000 and ad3 > 1000 and ad5 > self.FD and ad6 < self.RD and ad7 < self.BD and ad8 > self.LD:       #可
            # 在台下，前左检测到围栏
            return 5

        if ad3 > 1000 and ad4 > 1000 and ad5 > self.FD and ad6 > self.RD and ad7 < self.BD and ad8 < self.LD:       #可
            # 在台下，前右检测到围栏
            return 6
    ...
    def start_match(self):
        ...
        self.controller.move_cmd(400,800)
        time.sleep(0.5)
        while 1:
            ...
            if stage == 0:
                ...
                if fence == 1:
                    ...
                    self.go_up_behind_platform()    #后上台             #4.1s
