...
class MatchDemo:
    ...
    def pack_up_ahead(self):
        self.controller.up.CDS_SetAngle(5, 370, self.servo_speed)
    ...
    def pack_up_behind(self):
        self.controller.up.CDS_SetAngle(6, 395, self.servo_speed)
        self.controller.up.CDS_SetAngle(8, 585, self.servo_speed)
    ...
    def fence_detect(self):
        ...
        if ad3 < 1000 and ad4 < 1000 and ad7 < self.FD and ad8 < self.LD:
            ...
            return 18
        # elif io_0 == 1 and io_1 == 1 and io_2 == 1 and io_3 == 1 and ad5 > self.FD:
        #     # 搁浅放在擂台下,前低后高
        #     return 19
        # elif io_0 == 1 and io_1 == 1 and io_2 == 1 and io_3 == 1 and ad7 > self.BD:
        #     # 搁浅放在擂台上，前高后低
        #     return 20
        # elif io_0 == 1 and io_1 == 1 and io_2 == 1 and io_3 == 1 and ad6 > self.RD:
        #     # 搁浅放在擂台上，左高右低
        #     return 21
        # elif io_0 == 1 and io_1 == 1 and io_2 == 1 and io_3 == 1 and ad8 > self.LD:
        #     # 搁浅放在擂台上，右高左低
        #     return 22
        else:
            # print("else")
